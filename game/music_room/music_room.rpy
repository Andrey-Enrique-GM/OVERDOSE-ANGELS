...
init python:
    ...
    my_room = ExtendedMusicRoom(channel='music', fadeout=0.0, fadein=0.0,
    ...
    my_room.default_art = "gui/music_room/cover_art.webp"


    my_room.add(
        name=_("BGLF"),
        path="audio/bgm/BGLF.flac",
        artist="Migna", 
